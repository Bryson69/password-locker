...
class TestUser(unittest.TestCase):
    ...
    def test_save_multiple_user(self):
        '''
        test_save_multiple_user to check if we can save multiple contact objects to our user_list
        '''
    ...
    def test_contact_exists(self):
        '''
        test to check if we can return a Boolean if we cannot find the new user
        '''
        self.new_user.save_user()
        test_user  = User("Test","user","0711223344","test@user.com")#new user
        test_user.save_user()
    ...
    def test_display_all_users(self):
        '''
        method that rerurns a list of all users saved 
        '''
