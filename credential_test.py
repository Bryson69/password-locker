...
class TestUSer(unittest.TestCase):
    ...
    def test_init(self):
        """
        test_init_ test case to test if the object is properly initialized
        """
    ...
    def test_save_cred(self):
        """
         test_save_creden test case to test if the credential object is saved into the crentials array
        """
    ...
    def test_display_credentials(self):
        ...
        self.assertEqual(Credential.display_credential(),Credential.credentials_array)
